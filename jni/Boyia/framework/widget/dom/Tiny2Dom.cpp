...
void Tiny2Dom::createRenderTree(XMLNode* elem, XMLNode* parentElem, HtmlView* parent)
{
...
HtmlView* Tiny2Dom::createHtmlView(XMLNode* node, XMLNode* parentElem, HtmlView* parent)
{
	HtmlView* item = NULL;
