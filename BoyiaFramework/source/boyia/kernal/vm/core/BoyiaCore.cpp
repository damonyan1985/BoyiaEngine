...
static LVoid BreakStatement()
{
    ...
    PutInstruction(NULL, NULL, BY_BREAK, HandleBreak);
}
...
{
    Instruction* logicInst = PutInstruction(NULL, NULL, BY_ELSE, NULL);
    BlockStatement();
...
{
    EvalExpression(); // => R0
    PutInstruction(NULL, NULL, BY_RETURN, HandleReturn);
}
